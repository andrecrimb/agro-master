/*
  ...
  - You are about to drop the `OwnerProperties` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropForeignKey
ALTER TABLE `OwnerProperties` DROP FOREIGN KEY `ownerproperties_ibfk_1`;
